...
@click.pass_context
@click.option(
    "--source", help="Directory or archive name for input dataset", required=True, metavar="PATH"
)
@click.option(
    "--dest",
...
@click.option(
    "--resolution", help="Output resolution (e.g., '512x512')", metavar="WxH", type=parse_tuple
)
def convert_dataset(
    ctx: click.Context,
    source: str,
