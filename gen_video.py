...
@click.option(
    "--shuffle-seed", type=int, help="Random seed to use for shuffling seed order", default=None
)
@click.option(
...
@click.option(
    "--w-frames", type=int, help="Number of frames to interpolate between latents", default=120
)
@click.option(
