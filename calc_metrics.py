...
@click.option(
    "--data", help="Dataset to evaluate against  [default: look up]", metavar="[ZIP|DIR]"
)
@click.option(
    "--mirrorx", help="Enable dataset x-flips  [default: look up]", type=bool, metavar="BOOL"
)
@click.option(
    "--mirrory", help="Enable dataset y-flips  [default: look up]", type=bool, metavar="BOOL"
)
@click.option(
